...
* @route '/livewire-246c2ea1/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-246c2ea1/upload-file',
...
* @route '/livewire-246c2ea1/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-246c2ea1/preview-file/{filename}',
