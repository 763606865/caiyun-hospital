...
* @route '/livewire-5c6e244d/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-5c6e244d/upload-file',
...
* @route '/livewire-5c6e244d/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-5c6e244d/preview-file/{filename}',
