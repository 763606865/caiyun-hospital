...
* @route '/livewire-5c6e244d/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-5c6e244d/livewire.js',
...
* @route '/livewire-5c6e244d/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-5c6e244d/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-5c6e244d/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-5c6e244d/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
