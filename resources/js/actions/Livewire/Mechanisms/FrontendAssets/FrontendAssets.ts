...
* @route '/livewire-246c2ea1/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-246c2ea1/livewire.js',
...
* @route '/livewire-246c2ea1/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-246c2ea1/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-246c2ea1/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-246c2ea1/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
